...
- **Details modal** — day-by-day breakdown table for the current pay period (see start, end, break, hours, decimal per day + total OT)
...
6. Hit **Save** to persist the entry
7. The summary bar at the bottom updates automatically with logged hours, decimal, days, overtime, and remaining
